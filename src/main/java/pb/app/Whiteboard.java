...
public class Whiteboard {
	 ...
	 */
	//used for local board
	ArrayList<Endpoint> subscribers=new ArrayList<Endpoint>();
	//used for remote board
	Endpoint manageEndpoint=null;
	...
	public Whiteboard(String name,String pathCode,long version,boolean remote) {
		this.paths = new ArrayList<>();
		String[] paths=pathCode.split("%");
		for(String path:paths) {
			System.out.println(path);
			WhiteboardPath wPath=new WhiteboardPath(path);
			this.paths.add(wPath);
		}
		this.name=name;
